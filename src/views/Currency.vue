    ...
    <el-col :span="24">
      <el-card class="box-card box-card-wrapper">
        ...
        <el-row class="row-wrapper">
          ...
          <el-col :span="12">
            <el-input v-model="request.name" placeholder="New Name..." clearable></el-input>
          </el-col>
        </el-row>
        <el-row class="row-wrapper">
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-input v-model="request.symbol" placeholder="New Symbol..." clearable></el-input>
          </el-col>
        </el-row>
        <el-row class="row-wrapper">
          <el-col :span="24">
    ...
    <el-col :span="24">
      <el-card class="box-card">
        ...
        <el-table :data="currencies" style="width: 100%">
          <el-table-column prop="id" label="通貨ID" width="200" />
          <el-table-column prop="name" label="通貨名" width="200" />
          <el-table-column prop="symbol" label="通貨単位" width="200" />
